...
{
    public class PersonRelationEnumRepository : EnumRepository, IPersanRelationEnumRepository
    {
        public PersonRelationEnumRepository(AlbimDbContext dbContext) : base(dbContext)
        {
        }
